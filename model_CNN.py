...
path1 = 'D:/pan card detection/pan card detection/pan card detection/testing/0'    #path of folder of images    
path2 = 'D:/pan card detection/pan card detection/pan card detection/testing_set/0'  #path of folder to save images    
